<template>
  <div class="all">
    <div class="container log-list">   
       <map id="map" class="map" longitude="118.4914" latitude="31.5210" scale="12" controls="controls"  markers="markers"  polyline="polyline" @controltap="controltap" @markertap="markertap" @regionchange="regionchange" show-location style="width: 750rpx; height: 360rpx;"></map>
      
      <div class="map_info">
        <div class="title">关于墨客云</div>
        <div class="icon"></div>
